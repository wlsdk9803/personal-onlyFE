          ...
          <Background>
            ...
            <Mainbox>
              ...
              <StepIconWrapper marginTop="8px">
                <Button
                  ...
                  margin="1px"
                  onClick={() => setButtonCQ2(1)}
                  backgroundColor={buttonCQ2 >= 1 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ2(2)}
                  backgroundColor={buttonCQ2 >= 2 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ2(3)}
                  backgroundColor={buttonCQ2 >= 3 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ2(4)}
                  backgroundColor={buttonCQ2 >= 4 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ2(5)}
                  backgroundColor={buttonCQ2 >= 5 ? "#eb76f1" : "#e8e8e8"}
                />
              </StepIconWrapper>
              <TextBox
                color="#A3A3A3"
            ...
            >
              <Button
                ...
                color={buttonCQ2 > 0 ? "white" : "black"}
                cursor={buttonCQ2 > 0 ? "pointer" : "default"}
              >
                <IoIosArrowForward />
              </Button>
            </Link>
