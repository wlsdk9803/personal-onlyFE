...
const ColorQ4 = () => {
  ...
  const [buttonCQ4, setButtonCQ4] = useState(
    location.state && location.state.CQ4 ? location.state.CQ4 : 0
  );
  const buttonCQ1 =
      ...
      >
        <Wrapper>
          <Background>
            ...
            <Mainbox>
              ...
              <StepIconWrapper marginTop="8px">
                <Button
                  ...
                  margin="1px"
                  onClick={() => setButtonCQ4(1)}
                  backgroundColor={buttonCQ4 >= 1 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ4(2)}
                  backgroundColor={buttonCQ4 >= 2 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ4(3)}
                  backgroundColor={buttonCQ4 >= 3 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ4(4)}
                  backgroundColor={buttonCQ4 >= 4 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ4(5)}
                  backgroundColor={buttonCQ4 >= 5 ? "#eb76f1" : "#e8e8e8"}
                />
              </StepIconWrapper>
              <TextBox
                color="#A3A3A3"
            ...
            <Link
              to={buttonCQ4 > 0 ? "/colorQ5" : "/colorQ4"}
              state={{
                CQ1: buttonCQ1,
                CQ2: buttonCQ2,
                CQ3: buttonCQ3,
            ...
            >
              <Button
                ...
                color={buttonCQ4 > 0 ? "white" : "black"}
                cursor={buttonCQ4 > 0 ? "pointer" : "default"}
              >
                <IoIosArrowForward />
              </Button>
            </Link>
