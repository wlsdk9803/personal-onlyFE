          ...
          <Background>
            ...
            <Mainbox>
              ...
              <StepIconWrapper marginTop="8px">
                <Button
                  ...
                  margin="1px"
                  onClick={() => setButtonCQ5(1)}
                  backgroundColor={buttonCQ5 >= 1 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ5(2)}
                  backgroundColor={buttonCQ5 >= 2 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ5(3)}
                  backgroundColor={buttonCQ5 >= 3 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ5(4)}
                  backgroundColor={buttonCQ5 >= 4 ? "#eb76f1" : "#e8e8e8"}
                />
                <Button
                  padding="32px 23px 32px 23px"
                  margin="1px"
                  onClick={() => setButtonCQ5(5)}
                  backgroundColor={buttonCQ5 >= 5 ? "#eb76f1" : "#e8e8e8"}
                />
              </StepIconWrapper>
              <TextBox
                color="#A3A3A3"
            ...
            >
              <Button
                ...
                color={buttonCQ5 > 0 ? "white" : "black"}
                cursor={buttonCQ5 > 0 ? "pointer" : "default"}
              >
                <IoIosArrowForward />
              </Button>
            </Link>
